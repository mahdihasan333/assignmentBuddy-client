...
const Contact = ({ isDarkMode }) => {
  ...
  return (
    <section
      className={`w-full mt-8 py-16 px-6 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-100'} text-white`}
    >
      <div className="container mx-auto text-center">
        <h2 className="text-3xl font-bold text-green-500">Contact Me</h2>
        <p className="mt-2 text-lg text-gray-400">Feel free to reach out to me with any questions!</p>
        ...
        <div className="mt-8 max-w-3xl mx-auto">
          <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div className="mt-6">
              <button
                type="submit"
                className="px-6 py-3 w-full bg-green-500 hover:bg-green-600 text-white rounded-lg transition duration-300"
              >
                Send Message
              </button>
            </div>
