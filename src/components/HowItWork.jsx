    ...
    <div className="max-w-6xl mx-auto my-16 p-6 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {steps.map((step, index) => (
          <div key={index} className="bg-white dark:bg-gray-800 p-6 shadow-md rounded-lg flex flex-col items-center text-center">
            {step.icon}
            <h3 className="text-xl font-semibold dark:text-white mt-4">{step.title}</h3>
